...
func (t *cc1) showToken(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
func (t *cc1) createAccount(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	if len(args) != 1 {
...
func (t *cc1) showAccount(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
func (t *cc1) initCurrency(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	if len(args) != 4 {
...
func (t *cc1) setLock(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
func (t *cc1) balance(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
func (t *cc1) Query(stub shim.ChaincodeStubInterface) pb.Response {
	function, args := stub.GetFunctionAndParameters()
	if function == "balance" {
		return t.balance(stub, args)
	}
...
func (t *cc1) mintToken(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
func (t *cc1) transferToken(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
func (t *cc1) frozenAccount(stub shim.ChaincodeStubInterface, args []string) pb.Response {
